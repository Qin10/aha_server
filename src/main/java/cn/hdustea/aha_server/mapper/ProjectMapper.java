...
public interface ProjectMapper {
    ...
    List<ProjectRoughVo> selectAllRoughByConditions(@Param("createUserId") Integer createUserId, @Param("compId") Integer compId, @Param("awardLevel") Integer awardLevel, @Param("passed") Boolean passed);
